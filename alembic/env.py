...
# Для Alembic убираем +asyncpg → используем синхронный драйвер psycopg2,
# либо оставляем asyncpg и используем async-движок ниже.
# Здесь мы используем async-движок, поэтому оставляем asyncpg как есть.
